  ...
  paraxify = function(el, options) {
    ...
    Paraxify.prototype = {
      ...
      _animate: function() {
        ...
        while (i < pho.length) {
          this._check(i);
          if (pho[i].ok && ((posY + screenY) > pho[i].offsetTop) && (posY < pho[i].offsetTop + pho[i].offsetHeight) && window.getComputedStyle(pho[i], false).backgroundAttachment === "fixed") {
